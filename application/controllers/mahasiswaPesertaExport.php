...
class mahasiswaPesertaExport extends CI_Controller {

    private $mahasiswaPesertaExportModel;

    public function __construct() {
        parent::__construct();
        $this->load->library('session');

        $this->load->model('MahasiswaPesertaExportModel');
        $this->mahasiswaPesertaExportModel=$this->MahasiswaPesertaExportModel;
    }

    public function export() {
        $dataPengampu = $this->mahasiswaPesertaExportModel->getListDosenPengampuById($_GET['id']);
        $dataPeserta = $this->mahasiswaPesertaExportModel->getListPeserta($_GET['id']);
        $dataHarkat = $this->mahasiswaPesertaExportModel->getListHarkat();
