...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
			$this->load->view('masterCapaianPembelajaranLulusan/readMain');
		?>
  </div>
	<?php
...
<script>
  ...
  $(document).ready(function () {
    ...
    var urlGetListCPL = "<?php echo base_url('CapaianPembelajaranLulusan/getListCapaianPembelajaranLulusan') ?>";
		$('#listCapaianPembelajaranLulusan').DataTable({
			"ordering": false,
			"autoWidth": false,
			"processing": true,
			"serverSide": true,
			...
			"columns": [
				...
				{ "data": "aksi", "className": "text-center", "width": "15%"},
				{ "data": "nama", "width": "15%" },
				{ "data": "deskripsi" }
			]  
		});
