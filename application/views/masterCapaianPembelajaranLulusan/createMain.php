						...
						<div class="row">
							<div class="col-md-12">
								<center>
									...
									<a href="<?php echo base_url('capaian-pembelajaran-lulusan') ?>"><button type="button" class="btn btn-default"><i class="fa fa-minus-circle" aria-hidden="true"></i> Batal</button></a>
								</center>
