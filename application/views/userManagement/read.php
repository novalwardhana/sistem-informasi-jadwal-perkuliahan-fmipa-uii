...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
			$this->load->view('userManagement/readMain');
		?>
  </div>
...
<script>
	...
	$(document).ready(function () {
		...
		var urlGetListUserManagement = "<?php echo base_url('UserManagement/getListUserManagement') ?>";
		$('#listUserManagement').DataTable({
			"ordering": false,
			"autoWidth": false,
			"processing": true,
			"serverSide": true,
