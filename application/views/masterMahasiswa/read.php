...
<?php
	$this->load->view('masterMahasiswa/readDeleteModal');
?>
...
<script>
  ...
  $(document).ready(function () {
		...
		$(".menu-sidebar-master-mahasiswa").addClass('active');
    ...
    var urlGetListMahasiswa = "<?php echo base_url('mahasiswa/getListMahasiswa') ?>";
