<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <input type="number" id="modalUpdateCPMK1Persentase" step="0.01" min="0" max="100" placeholder="1 - 100" class="form-control" name="cpmk_1_persentase" style="text-align:right;" required/>
