...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".menu-sidebar-jadwal-perkuliahan-jadwal").addClass('active');
        ...
        let urlGetListJadwalPerkuliahan = "<?php echo base_url('jadwal-perkuliahan/get-jadwal') ?>";
		$('#listJadwalPerkuliahan').DataTable({
			"ordering": false,
			"autoWidth": false,
			"processing": true,
			"serverSide": true,
			"ajax":{
				"url": urlGetListJadwalPerkuliahan,
				"dataType": "json",
				"type": "POST",
				"data":{
