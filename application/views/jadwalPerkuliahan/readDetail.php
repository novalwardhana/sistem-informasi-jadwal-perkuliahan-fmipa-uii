                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="<?php echo base_url('JadwalPerkuliahanExport/export?id=').$dataPengampu->id_dosen_pengampu_mata_kuliah ?>"><button class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export</button></a>
																<a href="<?php echo base_url('jadwal-perkuliahan/upload-nilai?id=').$dataPengampu->id_dosen_pengampu_mata_kuliah ?>"><button class="btn btn-success"><i class="fa fa-file-excel-o"></i> Import</button></a>
                                <br><br>
