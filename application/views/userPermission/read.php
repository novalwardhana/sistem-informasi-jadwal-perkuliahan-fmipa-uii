...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
			$this->load->view('userPermission/readMain');
		?>
  </div>
  <?php
...
<?php
	$this->load->view('userPermission/deleteModal');
?>
...
<script>
	...
	$(document).ready(function () {
		...
		var urlGetListUserPermission = "<?php echo base_url('UserPermission/getListUserPermission') ?>";
		$('#listUserPermission').DataTable({
			"ordering": false,
			"autoWidth": false,
			"processing": true,
			"serverSide": true,
			...
			"columns": [
				...
				{ "data": "aksi", "className": "text-center", "width": "4%"},
				{ "data": "nama", "width": "15%" },
