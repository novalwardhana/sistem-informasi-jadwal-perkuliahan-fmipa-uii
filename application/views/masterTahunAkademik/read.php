...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
			$this->load->view('masterTahunAkademik/readMain');
		?>
  </div>
  <?php
...
<?php
	$this->load->view('masterTahunAkademik/readDeleteModal');
?>
...
<script>
  ...
  $(document).ready(function () {
		...
		$(".menu-sidebar-master-tahun-akademik").addClass('active');
    ...
    var responseModule="";
		...
		var urlGetListTahunAkademik = "<?php echo base_url('TahunAkademik/getListTahunAkademik') ?>";
		$('#listTahunAkademik').DataTable({
			"ordering": false,
			"autoWidth": false,
			"processing": true,
			"serverSide": true,
			"ajax":{
				"url": urlGetListTahunAkademik,
				"dataType": "json",
				"type": "POST",
				"data":{
			...
			"columns": [
				...
				{ "data": "tahun_akademik", "className": "text-center" },
