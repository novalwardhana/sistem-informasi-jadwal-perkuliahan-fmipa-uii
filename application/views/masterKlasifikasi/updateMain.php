						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="number" value="<?php echo $dataKlasifikasi->batas_bawah ?>" name="batas_bawah" step="0.01" min="0" max="100" class="form-control" placeholder="Batas bawah rentang nilai" required>
								</div>
								<div class="form-group">
									<label>Batas Atas *</label>
									<input type="number" value="<?php echo $dataKlasifikasi->batas_atas ?>" name="batas_atas" step="0.01" min="0" max="100" class="form-control" placeholder="Batas atas rentang nilai" required>
								</div>
								<div class="form-group">
