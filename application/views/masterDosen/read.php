        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <a href="<?php echo base_url('dosen/create') ?>"><button type="button" class="btn btn-sm btn-success"><i class='fa fa-plus'></i> Tambah</button></a>
                        <br><br>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var urlGetListDosen = "<?php echo base_url('dosen/getListDosen') ?>";
        $('#listDosen').DataTable({
            "ordering": false,
            "autoWidth": false,
            "processing": true,
