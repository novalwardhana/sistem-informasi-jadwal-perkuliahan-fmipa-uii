...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$(".menu-sidebar-master-dosen").addClass('active');

        let idProdi = "<?php echo $dataDosen->id_prodi ?>"
        $(".selectProgramStudi").val(idProdi).trigger("change")

        document.forms["formData"].addEventListener("submit", (event) => {
            event.preventDefault()
            if (isNaN(document.forms["formData"]["id"].value) || isNaN(document.forms["formData"]["id_prodi"].value)) {
            ...
            let nik = document.forms["formData"]["nik"].value
            ...
            let url = "<?php echo base_url('master-dosen/update') ?>"
            $.ajax({
                headers: {
                ...
                success: function(result) {
                    ...
                    setTimeout(function(){
                        let redirectURL = "<?php echo base_url('master-dosen') ?>"
