...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
      $this->load->view('masterRuang/createMain');
    ?>
  </div>
	<?php
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$(".menu-sidebar-master-ruang").addClass('active');
        ...
        document.forms["formData"].addEventListener("submit", (event) => {
            ...
            if (isNaN(document.forms["formData"]["kapasitas"].value)) {
                $.toaster({ message : 'Gagal input data, parameter tidak valid', title : 'Warning', priority : 'warning' });
                return
            }
            let kapasitas = parseInt(document.forms["formData"]["kapasitas"].value)
            const dataBody = {
                "kode": kode,
                "nama": nama,
                "kapasitas": kapasitas,
            ...
            let url = "<?php echo base_url('master-ruang/create') ?>"
            $.ajax({
                headers: {
                ...
                success: function(result) {
                    ...
                    $.toaster({ message : 'Berhasil input data', title : 'Success', priority : 'success' });
                            setTimeout(function(){
                        let redirectURL = "<?php echo base_url('master-ruang') ?>"
