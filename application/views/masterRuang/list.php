...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
			$this->load->view('masterRuang/listMain');
		?>
  </div>
  <?php
...
<?php
	$this->load->view('masterRuang/deleteModal');
?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        let urlGetListData = "<?php echo base_url('master-ruang/get-data') ?>";
