				...
				<form role="form" name="formData">
					<div class="box-body">
						<div class="row">
                            ...
                            <input type="hidden" value="<?php echo $dataPeriode->id ?>" name="id" class="form-control" required>
                                <div class="form-group">
									<label>Tahun Akademik *</label>
									<select class="selectTahunAkademik form-control" value="<?php echo $dataPeriode->tahun_akademik ?>" style="width: 100%;" name="tahun_akademik" required>
										<option></option>
										<?php
