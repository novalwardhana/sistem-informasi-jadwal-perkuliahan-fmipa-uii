...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
      $this->load->view('masterMataKuliah/updateMain');
    ?>
  </div>
	<?php
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$(".menu-sidebar-master-mata-kuliah").addClass('active');

        let idProdi = "<?php echo $dataMataKuliah->id_prodi ?>"
        ...
        document.forms["formData"].addEventListener("submit", (event) => {
            ...
            if (isNaN(document.forms["formData"]["id"].value) || isNaN(document.forms["formData"]["id_prodi"].value) || isNaN(document.forms["formData"]["semester"].value) || isNaN(document.forms["formData"]["kontribusi_sks"].value)) {
                $.toaster({ message : 'Gagal input data, parameter tidak valid', title : 'Warning', priority : 'warning' });
                return
            }
            let id = parseInt(document.forms["formData"]["id"].value)
            let id_prodi = parseInt(document.forms["formData"]["id_prodi"].value)
            ...
            let url = "<?php echo base_url('master-mata-kuliah/update') ?>"
            $.ajax({
                headers: {
                ...
                success: function(result) {
                    ...
                    setTimeout(function(){
                        let redirectURL = "<?php echo base_url('master-mata-kuliah') ?>"
