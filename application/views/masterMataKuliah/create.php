...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
      $this->load->view('masterMataKuliah/createMain');
    ?>
  </div>
	<?php
...
<script type="text/javascript">
	$(document).ready(function () {
        ...
        document.forms["formData"].addEventListener("submit", (event) => {
            ...
            if (isNaN(document.forms["formData"]["id_prodi"].value) || isNaN(document.forms["formData"]["semester"].value) || isNaN(document.forms["formData"]["kontribusi_sks"].value)) {
            ...
            let url = "<?php echo base_url('master-mata-kuliah/create') ?>"
            $.ajax({
                headers: {
