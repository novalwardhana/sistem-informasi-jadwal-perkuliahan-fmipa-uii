		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Upload Mata Kuliah</h3>
				</div>
						...
						<div class="row">
							<div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo base_url('master-mata-kuliah') ?>"><button type="button" class="btn btn-default"><i class="fa fa-reply" aria-hidden="true"></i> Kembali</button></a>
                                </div>
							</div>
						</div>
					</div>
