...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
			$this->load->view('masterMataKuliah/readMain');
		?>
  </div>
...
<?php
	$this->load->view('masterMataKuliah/readDeleteModal');
?>
...
<script>
  ...
  $(document).ready(function () {
    ...
    var urlGetListMataKuliah = "<?php echo base_url('MataKuliah/getListMataKuliah') ?>";
