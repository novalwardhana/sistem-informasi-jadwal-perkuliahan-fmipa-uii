				...
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">Form Hasil Evaluasi Mandiri</h3>
						</div>
						<form role="form" method="post" action="<?php echo base_url('hasil-evaluasi-mandiri/laporan') ?>">
							<div class="box-body">
								<div class="row">
									<div class="col-md-6">
...
<script>
    ...
    $('.mahasiswaselect').select2({
      ...
      width: 'resolve',
      ajax: {
        url: "<?php echo base_url(); ?>EvaluasiMandiriHasil/comboMahasiswa",
        dataType: 'json',
