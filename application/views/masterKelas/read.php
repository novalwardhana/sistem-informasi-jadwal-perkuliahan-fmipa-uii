        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <a href="<?php echo base_url('kelas/create') ?>"><button type="button" class="btn btn-sm btn-success"><i class='fa fa-plus'></i> Tambah</button></a>
                        <br><br>
                        <table id="listKelas" class="table table-bordered table-striped" style="width: 100%">
                            <thead>
                                <tr>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var urlGetListKelas = "<?php echo base_url('kelas/getListKelas') ?>";
        $('#listKelas').DataTable({
            "ordering": false,
            "autoWidth": false,
            "processing": true,
